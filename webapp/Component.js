sap.ui.define([
    ...
    "sap/m/MessageToast"
], (UIComponent, models, AppService, AppState, MessageBox, Fragment, MessageToast) => {
    "use strict";
    ...
    return UIComponent.extend("framsys.com.framsysfrontend.Component", {
        ...
        onCancelLoginDialog: function () {
            let oRootView = this.getRootControl(); // Get the root view (usually the App view)
            
            if (oRootView) {
                oRootView.setBusy(true); // Set busy state
            }
        
            sap.m.MessageToast.show("Please select Login Person!");
